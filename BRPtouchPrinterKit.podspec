...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/envoy/BRPtouchPrinterKit.git", :tag => "1.2.6" }
  ...
  s.frameworks = "SystemConfiguration", "CFNetwork", "UIKit", "Foundation", "CoreGraphics", "BRPtouchPrinterKit"
